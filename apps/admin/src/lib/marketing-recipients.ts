...
/**
 * Opted-in, verified, active users eligible for a marketing blast. Each carries a
 * stable unsubscribe token (generated lazily for the rare user missing one — the
