...
export const metadata: Metadata = {
  ...
  description: 'WinUPrize responsible play policy. We take player welfare seriously.',
};
  ...
  return (
    <LegalPage title="Responsible Play" lastUpdated="Last updated: 1 April 2026" toc={tableOfContents}>
      <section id="our-commitment">
        ...
        <p className="legal-p">WinUPrize is committed to providing a safe, fair, and enjoyable experience for all participants. While our competitions are skill-based prize competitions (not gambling), we take player welfare seriously and have implemented measures to promote responsible play.</p>
      </section>

      <section id="not-gambling">
        <h3 className="legal-h">2. Skill Competitions, Not Gambling</h3>
        <p className="legal-p">WinUPrize operates prize competitions under the UK Gambling Act 2005. Our competitions require participants to answer a skill-based question and offer a free postal entry route. They are not classified as gambling.</p>
