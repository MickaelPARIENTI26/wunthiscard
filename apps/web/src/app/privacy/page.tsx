...
export const metadata: Metadata = {
  ...
  description:
    'Privacy policy for WinUPrize. Learn how we collect, use, and protect your personal data in compliance with UK GDPR.',
};
...
function PlaceholderPrivacyContent() {
  return (
    <>
      <p className="lead">
        This Privacy Policy explains how YD PARTNERS LTD (trading as WinUPrize) (&quot;we&quot;,
      ...
      <section id="introduction">
        ...
        <p>
          WinUPrize operates a prize competition platform for collectible
      ...
      <section id="data-controller">
        ...
        <p>YD PARTNERS LTD (trading as WinUPrize) is the data controller for your personal data.</p>
        <ul>
          <li>Company Name: YD PARTNERS LTD (trading as WinUPrize)</li>
