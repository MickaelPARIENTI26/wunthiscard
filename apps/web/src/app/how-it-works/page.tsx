...
const steps = [
  ...
  },
  {
    ...
    b: "When the comp sells out (or hits its end date), the winner is drawn by an independent third party. The result is published and verifiable on the competition page, and the winner is notified within 24h. Insured tracked shipping, free wherever you are.",
