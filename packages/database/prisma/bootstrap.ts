  ...
  if (faqCount === 0) {
    await prisma.faqItem.createMany({
      data: [
        ...
        // Legal & eligibility
        { category: 'Legal & Eligibility', sortOrder: 1, question: 'Is this a lottery?', answer: 'No. WinUPrize is a skill-based prize competition, fully compliant with the UK Gambling Act 2005. Every entry requires correctly answering a skill question, and a free entry route is always available.' },
        ...
        { category: 'Legal & Eligibility', sortOrder: 3, question: 'Who can participate?', answer: 'You must be 18 years or older to enter any WinUPrize competition. Age verification may be required for larger prizes.' },
        { category: 'Legal & Eligibility', sortOrder: 4, question: 'Who runs WinUPrize?', answer: 'WinUPrize is a trading name of YD PARTNERS LTD, a company registered in England & Wales (company number 16766570), with registered office at 71-75 Shelton Street, Covent Garden, London, WC2H 9JQ.' },
      ],
    });
