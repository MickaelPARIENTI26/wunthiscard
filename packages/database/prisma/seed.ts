...
async function main() {
  ...
  const competition1 = await prisma.competition.create({
    data: {
      ...
      questionAnswer: 0,
      metaTitle: 'Win a Charizard PSA 10 1st Edition Base Set | WinUPrize',
      metaDescription:
  ...
  const competition2 = await prisma.competition.create({
    data: {
      ...
      questionAnswer: 1,
      metaTitle: 'Win a Pikachu Illustrator Card | WinUPrize',
  ...
  const order1 = await prisma.order.create({
    data: {
      orderNumber: 'WUP-20260101-TEST1',
      userId: user1.id,
  ...
  const order2 = await prisma.order.create({
    data: {
      orderNumber: 'WUP-20260101-TEST2',
      userId: user2.id,
  ...
  const order3 = await prisma.order.create({
    data: {
      orderNumber: 'WUP-20260101-TEST3',
      userId: user1.id,
  ...
  await prisma.siteSettings.create({
    data: {
      ...
      data: {
        ...
        companyName: 'YD PARTNERS LTD (trading as WinUPrize)',
        companyAddress: '71-75 Shelton Street, Covent Garden, London, WC2H 9JQ, United Kingdom',
        companyEmail: 'contact@winuprize.com',
        socialLinks: {
        ...
        freeEntryAddress: 'WinUPrize Free Entry, YD PARTNERS LTD, 71-75 Shelton Street, Covent Garden, London, WC2H 9JQ',
      },
    },
  });
  ...
  const faqItems = [
    ...
    {
      category: 'Legal',
      question: 'Is WinUPrize legal in the UK?',
      answer:
        'Yes! WinUPrize operates as a prize competition (not a lottery) under the UK Gambling Act 2005. All entries require answering a skill-based question, and a free entry route is always available.',
      sortOrder: 1,
    },
    {
      category: 'Legal',
      question: 'What is the minimum age to participate?',
      answer: 'You must be 18 years or older to participate in any WinUPrize competition.',
      sortOrder: 2,
    },
  ];
  ...
  await prisma.staticPage.create({
    data: {
      ...
      title: 'About Us',
      content: `
        <h1>About WinUPrize</h1>
        <p>WinUPrize is the UK's premier prize competition platform for collectible cards and memorabilia.</p>
        <h2>Our Mission</h2>
        <p>We're passionate collectors who believe everyone should have the chance to own grail-tier collectibles. That's why we created WinUPrize - to give you the opportunity to win cards and memorabilia that would otherwise be out of reach.</p>
        <h2>Why Choose Us?</h2>
        <ul>
  ...
  await prisma.staticPage.create({
    data: {
      ...
      content: '<h1>Terms & Conditions</h1><p>Please read these terms carefully before using WinUPrize...</p>',
    },
  });
  ...
  const emailHeader = `
    <tr>
      <td align="center" style="padding: 30px 20px; border-bottom: 1px solid #222;">
        <img src="{{site_logo_url}}" alt="WinUPrize" width="144" height="80" style="display: block; max-width: 144px; height: auto;" />
      </td>
    </tr>`;
...
<body style="margin: 0; padding: 0; background-color: #0a0a0f; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
  ...
  const emailTemplates = [
    {
      ...
      subject: 'Verify your email — WinUPrize',
          ...
          <tr>
            <td style="padding: 30px 40px; color: #ffffff;">
              ...
              <p style="margin: 0 0 30px; font-size: 16px; line-height: 24px; color: #cccccc;">
                Thanks for signing up for WinUPrize! Please verify your email address to activate your account and start entering competitions.
              </p>
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
    ...
    },
    {
      slug: 'welcome',
      name: 'Welcome',
      subject: 'Welcome to WinUPrize! 🎉',
      trigger: EmailTrigger.AUTO,
      triggerDescription: 'Sent after email verified',
      htmlContent: wrapEmail(`
          <tr>
            <td style="padding: 30px 40px; color: #ffffff;">
              <h1 style="margin: 0 0 20px; font-size: 28px; color: #FFD700;">Welcome to WinUPrize!</h1>
              <p style="margin: 0 0 20px; font-size: 16px; line-height: 24px; color: #ffffff;">
                Hi {{user_firstname}},
              </p>
              <p style="margin: 0 0 30px; font-size: 16px; line-height: 24px; color: #cccccc;">
          ...
          <tr>
            <td style="padding: 30px 40px; color: #ffffff;">
                        ...
                        <td style="padding: 10px 0;">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td style="color: #cccccc; font-size: 14px;">
                                Share your win on social media and tag us @WinUPrize!
                              </td>
                            </tr>
                          </table>
                        </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center" style="padding: 20px 0;">
                    ${ctaButton('Confirm My Address', 'mailto:contact@winuprize.com?subject=Winner%20Address%20Confirmation')}
                  </td>
                </tr>
              </table>
  ...
  console.log('  Super Admin: admin@winuprize.com / Admin123!');
  console.log('  Admin: moderator@winuprize.com / Admin123!');
  console.log('  Draw Master: draw@winuprize.com / DrawMaster123!');
